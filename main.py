...
res = graph.invoke(
    {
        "messages": [
            {
                "role": "user",
                "content": "Write about AI powered SOC / autonomous oc problem domain, list startups that do that and raised capital.",
            }
        ]
    }
)

# Extract the last message from the result with tool calls
